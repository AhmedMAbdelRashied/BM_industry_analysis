...
Electricity_prompts = {
    "Introduction" :{"prompt": """Generate in [language] the following sections: 
    ...
    "Electricity Statistics": {"prompt": """Generate in [language] the following sections: 
    ...
    "Market updates in Globally": {"prompt": """Generate in [language] the following sections: 
    ...
    "Competitor Analysis": {"prompt": """Generate in [language] the following sections: 
        ### Competitve Analysis
    ...
    "BM Market Research":{"prompt":  """Generate in [language] the following sections: 
    ...
    "SWOT Analysis and Conclution": {"prompt": """
...
sugar_prompts = {
    "Introduction": {"prompt": """Generate the following sections in [language]:
    ...
    "Industry Statstics in Egypt": {"prompt": """Generate the following sections in [language]:
    ...
    "Industry Statstics in Egypt 2": {"prompt": """Generate the following sections in [language]:
    ...
    "Industry Statstics in Egypt 3": {"prompt": """Generate the following sections in [language]:
    ...
    "Market updates in Globally": {"prompt": """Generate the following sections in [language]:
    ...
    "Competitve Analysis": {"prompt": """Generate the following sections in [language]:
    ...
    "BM Market Research": {"prompt": """Generate the following sections in [language]:
    ...
    "Regulatory framework & Antidumping laws": {"prompt": """Generate the following sections in [language]: 
    ...
    "SWOT Analysis and Conclusion": {"prompt": """Generate the following sections in [language]:
